...
XData = Input(shape = (28,))
denX = Dense(35,init='uniform', activation='relu')(XData)
denX = Dropout(0.2)(denX)
denX = Dense(45, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(45, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(30, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(15, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(15, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(15, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(10, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(10, init='uniform', activation='relu')(denX)
denX = Dropout(0.2)(denX)
denX = Dense(10, init='uniform', activation='relu')(denX)
